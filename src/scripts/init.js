(() => {
  const adventureName = 'OSRIC Compendium';
   ...
   *   const creaturePacks = [];
   */
  const creaturePacks = ["osric-compendium.actors"];
  /**
   ...
   *   const journalPacks = [];
   */
  const journalPacks = ["osric-compendium.journals"];
  /**
   ...
   *   const macroPacks = [];
   */
  const macroPacks = ["osric-compendium.macros"];
  /**
   ...
   *   const playlistPacks = [];
   */
  const playlistPacks = ["osric-compendium.playlists"];
  /**
   ...
   */
  const additionalModulePacks = ["osric-compendium"];
